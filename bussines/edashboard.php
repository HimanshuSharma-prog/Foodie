    ...
    <div class="maindiv" id="maindiv">
        <div class="container">
            ...
            <div class="sidenav" id="sideNav">
                ...
                <ul id="navBtnDiv">
                    <li><a class="navBtn active" href="edashboard.php"><i class='bx bx-home-alt'></i><span>Dashboard</span><p class="option">Dashboard</p></a></li>
                                ...
                                while($row=mysqli_fetch_array($query)){
                                    ...
                                    echo" <div class='div'>
                                            <div class='closebtn'>
                                                ...
                                                <a href='edashboard.php?notify_remove=$update_id'> <i class='fa fa-times' aria-hidden='true' class='closeNotify'></i></a>
                                            </div>
