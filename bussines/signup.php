            ...
            if(isset($_POST['fname'])){
                ...
                if(is_numeric($mobile)){
                    ...
                    if(mysqli_num_rows($query) > 0){
                        ...
                        $sql="INSERT INTO emp(f_name,l_name,emp_name,emp_email,emp_mobile,emp_image,emp_password,emp_address) VALUES ('$f_name','$l_name','$uname','$email','$mobile','$final_file','$password','$address')";
                        $query=mysqli_query($conn,$sql);
