            ...
            <?php
                ...
                <div class="sidenav" id="sideNav">
                    ...
                    <ul>
                        ...
                        <li><a class="navBtn active" href="add_item.php"><i class='bx bx-add-to-queue'></i> <span>Add items</span> <p class="option">Add items</p></a></li>
                ...
                <?php
                    if(isset($_SESSION['a_id'])){
                        ...
                        $claimed=$row['claimed'];
                        if($claimed=='no'){
                            $err="<div class='notification' id='notificationDiv'><div class='error'><p>To access add item feature first claim your restaurant.</p></div> </div>";
                    ...
                    if(isset($_POST['item_name'])){
                        ...
                        move_uploaded_file($file_loc4,$folder.$final_file4);

                        $sql="INSERT INTO fooditems(emp_id,f_name,f_price,f_status,f_cat,f_time,f_type,f_img1,f_img2,f_img3,f_img4,r_address) VALUES ('$emp_id','$f_name','$f_price','$f_status','$f_cat','$f_time','$f_type','$final_file1','$final_file2','$final_file3','$final_file4','$r_address')";
                        $query=mysqli_query($conn,$sql);
                        ...
                        if($query){
                            ...
                            <div class='notification' id='notificationDiv'>
                                    <div class='success'>
                                        <p>Food item added succesfully.....</p>
                                    </div>
                            </div>";
                        }else{
                            echo "
                            <div class='notification' id='notificationDiv'>
                                    <div class='error'>
                                        <p>Food item not added. Try after some time.</p>
                                    </div>
                            </div>";
                        }
                    ...
                    <div class="additemdiv">
                        <form action="add_item.php" method="POST" enctype="multipart/form-data">
                            ...
                            <select name="food_time" required>
                                <option selected disabled>Select food timing</option>
