            ...
            if(isset($_POST['fname'])){
                ...
                if(is_numeric($mobile)){
                    ...
                    if(mysqli_num_rows($query) > 0){
                        ...
                        $sql="INSERT INTO admin(admin_id,f_name,l_name,admin_name,admin_email,admin_mobile,admin_image,admin_password,admin_address) VALUES ('$admin_id','$f_name','$l_name','$uname','$email','$mobile','$final_file','$password','$address')";
                        $query=mysqli_query($conn,$sql);
                    ...
                    <form action="signup.php" method="POST" enctype="multipart/form-data">
                        <div class="col">
                            ...
                            <div class="img">
                                ...
                                <input type="file" name="eimage" required>
                            </div>
                        </div>
                        <div class="col">
                            <div class="password">
